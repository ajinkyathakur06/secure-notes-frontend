...
export default function RequestsPage() {
  ...
  const getSectionClasses = (id: string) => {
    ...
    // Base classes
    let classes = "transition-all duration-500 ease-in-out h-[600px] ";
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-[#f7f7f6] px-4 sm:px-6 lg:px-8 pb-6 pt-2 flex flex-col">
